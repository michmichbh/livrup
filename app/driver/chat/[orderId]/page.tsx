...
export default function DriverChatPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <header className="sticky top-0 z-10 bg-emerald-600 px-4 py-3 flex items-center gap-3">
        <Button
          variant="ghost"
          size="icon"
      ...
      <div className="fixed bottom-20 left-0 right-0 bg-card border-t border-border px-4 py-3">
        <div className="flex items-center gap-2">
          <Input
            ...
            className="flex-1 h-12 rounded-2xl border-2 focus:border-emerald-500"
            value={newMessage}
          ...
          <Button
            size="icon"
            className="w-12 h-12 rounded-2xl flex-shrink-0 bg-emerald-600 hover:bg-emerald-700"
            onClick={sendMessage}
